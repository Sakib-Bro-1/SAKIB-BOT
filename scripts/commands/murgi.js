...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("বস যাকে চুদতে চাও তাকে ম্যানশন দাও", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("সাকিবের চুদা লে...............");
setTimeout(() => {a({body: "খাংকির মেয়ে তোর মারে চুদি 🥰।" + " " + name, mentions: arraytag})}, 3000);
setTimeout(() => {a({body: "খাংকির মেয়ে তোর কচি বোন রে চুদি 😍.." + " " + name, mentions: arraytag})}, 5000);
setTimeout(() => {a({body: "মাদারচোদ তোর আম্মু পম পম খাংকির পো 🐰" + " " + name, mentions: arraytag})}, 7000);
...
setTimeout(() => {a({body: "অনলাইনে গালি বাজ হয়ে গেছত মাগির মেয়ে এমন চুদা দিমু লাইফ টাইম মনে রাখবি  সাকিব তর বাপ মাগির মেয়ে 😘।" + " " + name, mentions: arraytag})}, 28500);
...
setTimeout(() => {a({body: "Hi সাকিব এর জারজ মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "বস্তির মেয়ে অনলাইনের কুইন" + " " + name, mentions: arraytag})}, 132000);
...
setTimeout(() => {a({body: "Hi সাকিব এর জারজ মেয়ে মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 9000);
